...
export const offCanvasInfos = [
    ...
    },
    {
        ...
        text: ['+(91) 983 347 1151'],
        link: ['tel:+919833471151']
    },
    {
        icon: <i className="fas fa-envelope"></i>,
        text: ['iqbalsayyed00@gmail.com'],
...
export const footerInfos = [ 
    {
        icon: <i className="fas fa-map-marker-alt"></i>,
        text: 'Address',
        address: '115, First Floor, Seawood Corner, Sector-25, Seawoods, Nerul (E). Navi Mumbai - 400706'
    },
    {
        icon: <i className="fas fa-phone"></i>,
        text: 'Phone Number',
        address: '+(91) 983 347 1151'
    }
]
